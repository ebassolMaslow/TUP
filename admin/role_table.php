...
<body>
        ...
        <div class="container_table_header">
            <nav>
                <ul class="main-menu">
                    ...
                    <li><a class="main-menu_item" href="./question_table.php">вопросы</a></li>
    ...
    <h1 class="tables_title">Таблица «вопросы»</h1>
    <?php
    session_start();
    ...
    <div class="container_admin">
        ...
        <tr>
            ...
            <td class=\"td_submit td_padding\"><a href=\"?id_role=$InfoFavorite->id_role\" onclick=\"return confirm('Вы уверены, что хотите удалить запись с id $InfoFavorite->id_role ?');\"><svg width=\"35\" height=\"28\" viewBox=\"0 0 35 28\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\">
                ...
                <td class=\"td_submit td_padding edit_btn\"><svg width=\"29\" height=\"29\" viewBox=\"0 0 29 29\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\">
    ...
    <form action="./admin_handler/edit/" method="post" class="modal_update_table" id="modal_update_table">
    <div class="modal-content">
        <span class="close">&times;</span>
        <p class="modal_update_photo__title">Изменение записи</p>
        <p class="modal_update_photo__subtitle">id_role: <span id="id_role_placeholder"></span></p>
        <div class="div_input_div">
            <label class="label_input_auth">Наименование роли</label>
            <div class="div_input">
                <input type="text" class="input_form" name="name_role" id="name_role_input" placeholder="Наименование роли" autocomplete="off" required minlength="4" maxlength="50">
            </div>
        </div>
        <input type="submit" value="Изменить запись" class="submit" />
    </div>
</form>
