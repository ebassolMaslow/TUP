...
<body>
    <h1 class="reset_password__title">Введите свой email для сброса пароля</h1>
    <form action="./php_handler/handle_password_reset.php" method="post" class="form_reset_password">
        ...
        <div class="div_input">
            <input type="email" class="input_form" name="email" placeholder="Ivanov@mail.ru" autocomplete="off" required minlength="8" maxlength="30">
        </div>
        <input type="submit" name="submit" class="submit" value="Отправить инструкции по сбросу пароля">
